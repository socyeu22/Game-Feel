...
{
    [SerializeField] private GameObject __spotlightHead; // Đối tượng đại diện cho đầu của đèn
    [SerializeField] private float _rotationSpeed = 10f; // Tốc độ quay của đèn
    ...
    private void RotateHead() {
        ...
        __spotlightHead.transform.localRotation = Quaternion.Euler(0, 0, z); // Đặt góc quay cho đèn
    }
    ...
    private void RandomStartingRotation() {
        ...
        __spotlightHead.transform.localRotation = Quaternion.Euler(0, 0, randomStartingZ); // Đặt góc quay cho đèn
